...
namespace RPG_BeginnersShop
{
    ...
    {   
        static void Main(string[] args)
        {
            ...
            Items testItem = new Items("Test item", 1000, 0, 5, 9999);
            Items emptyItem = new Items();
            Items testCloneItem = testItem;
            ...
            while (cmd.ToLower() != "leave")
            {
                ...
                if (lcmd == "sell")
                {
                    ...
                    else Console.WriteLine("You do not have an item to sell");
                }
                    ...
                    if (MyInventory.Any())
                    {
                        ...
                        if (AreYouReady == "y")
                        {
                            ...
                            while (PChealth.Health > 0 && PChealth.EnemyHealth > 0)
                            {
                                ...
                                else Console.WriteLine("The Shopkeeper is down");
                            }
                            ...
                            else Console.WriteLine("You have won and are ready to go on your quest");
                        }
                    }
                    else Console.WriteLine("You are not ready, get an item then you can challenge me");
                }
                ...
                if (lcmd == "mine")
                {
                   ...
                   else Console.WriteLine("You are to tired to mine.");
                }
                ...
                if (lcmd == "sleep")
                {
                    ...
                    else Console.WriteLine("Days are limited, you don't have all the time in the world to do this.");
                }
                ...
                if(lcmd == "rarestones")
                {
                    ...
                    if (YesorNoR == "y" && Money.RareStone >= RareStoneInventory[tmp].ShopSell)
                    {
                        Items Bought = new Items();
